<%@ Page Title="" Language="C#" MasterPageFile="~/Lab.Master" AutoEventWireup="true" CodeBehind="DoctorIndex.aspx.cs" Inherits="Lab_Project.DoctorIndex" %>
    ...
    <div class="pm_container">
        <div class="pm_header">
            <div class="pm_new-button-container">
                <a href="DoctorCreate.aspx" id="pm_newBtn">New</a>
            </div>
