<%@ Page Title="" Language="C#" MasterPageFile="~/Lab.Master" AutoEventWireup="true" CodeBehind="FormIndex.aspx.cs" Inherits="Lab_Project.FormIndex" %>
    ...
    <div class="pm_container">
        <div class="pm_header">
            <div class="pm_new-button-container">
                <a href="Index.aspx" id="pm_newBtn">New</a>
            </div>

            <div class="pm_date-container">
                <input type="date" id="pm_fromDate" placeholder="From Date">
                <input type="date" id="pm_toDate" placeholder="To Date">
            ...
            <table id="pm_patientTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="pm_action-buttons">
                                <button class="pm_edit-btn" data-id="4">Edit</button>
                                <button class="pm_delete-btn" data-id="4">Delete</button>
                            </div>
                        </td>
                        <td>2023-05-04</td>
                        <td>PT004</td>
                    ...
                    <tr>
                        <td>
                            <div class="pm_action-buttons">
                                <button class="pm_edit-btn" data-id="5">Edit</button>
                                <button class="pm_delete-btn" data-id="5">Delete</button>
                            </div>
                        </td>
                        <td>2023-05-05</td>
                        <td>PT005</td>
