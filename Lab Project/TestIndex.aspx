<%@ Page Title="" Language="C#" MasterPageFile="~/Lab.Master" AutoEventWireup="true" CodeBehind="TestIndex.aspx.cs" Inherits="Lab_Project.TestIndex" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <nav>
         <ol class="breadcrumb">
             <li class="breadcrumb-item"><a href="index.html">Blood Test Management</a></li>
 ...
 <div class="pm_container">
     <div class="pm_header">
         <div class="pm_new-button-container">
             <a href="TestCreate.aspx" id="pm_newBtn">New</a>
         </div>
